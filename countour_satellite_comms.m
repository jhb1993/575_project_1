[science_vol,comms_vol] = meshgrid(0:1:100,0:1:100);

gps_vol = 15.7011; % From optimize_satellite.m
camera_vol = 4.4996; % From optimize_satellite.m
...
%This value seems reasonable after looking at 
...
[C,h] = contour(science_vol,comms_vol,net_profit,'k');
clabel(C,h,'Labelspacing',250);
xlabel('Science Experiment Volume', 'FontSize', 20);
ylabel('Communications Volume', 'FontSize', 20);
hold on;
contour(science_vol,comms_vol,-max_volume+total_vol,[0,0],'g-','LineWidth',2);
contour(science_vol,comms_vol,-max_weight+total_weight,[0,0],'b-','LineWidth',2);
contour(science_vol,comms_vol,-max_cost+costs_total,[0,0],'r-','LineWidth',2);
